...
const CartDrawer: React.FC<CartDrawerProps> = ({ isOpen, onClose }) => {
  ...
  const { setCartDrawerOpen, setMobileNavbarOpen, selectIsCartLoading } = useAuth()

  // Check if either cart loading or fetching cart item loading is true
  const isLoading = selectIsCartLoading || isFetchCartItemLoading;
      ...
      >
        <div className='relative'>
          ...
          <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-background z-50">
            <CircularProgress sx={{margin:0, padding: 0}}/>
          </div>
          )}
