    ...
    <div className='mx-auto max-w-c-1390 py-4 w-full lg:px-12 2xl:px-0'>
        <div className='w-full'>
            <div className='mx-0 xl:mx-12'>
                ...
                <div className='grid grid-cols-1 xl:grid-cols-5 xl:gap-0 bg-background rounded-md'>
                    <div className='w-full xl:col-span-2 flex gap-8 pl-4'>
                    ...
                    <div className='col-span-3 relative mt-8'>
                        <div className='ml-4'>
                            <p className='text-[23px] font-medium'>{product.name}</p>
