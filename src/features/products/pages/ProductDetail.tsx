                            ...
                            <div className='flex flex-row gap-2'>
                                {
                                    product.variations.map((variation, index) => (
                                        <div className='w-min cursor-pointer' onClick={() => {
                                            ...
                                            <Chip label={variation.sku} sx={{
                                                ...(index === selectedVariant && {backgroundColor: "#FC2779", color: "#FFFFFF"}),
                                                ...(index !== selectedVariant && { backgroundColor: "#FFFFFF", border: "1px solid #FF92BB", color: "#FC2779"}),
                                            }}/>
                                        </div>
                                    ))
                                }
                        ...
                        <div className='hidden absolute bottom-0 left-0 w-full bg-background lg:block'>
                            <div className='hidden lg:flex lg: gap-2 lg:w-full lg:mt-0 lg:p-4'>
                                <div className='flex items-center gap-2 p-2 border-2 flex-1 rounded-sm'>
                                    ...
                                    <div>
                                        <p className='text-[15px] text-primary font-bold'>100% Authentic</p>
                                        <p className='text-[12px]'>view certificate</p>
                                    </div>
                                </div>
                                <div className='flex items-center gap-2 p-2 border-2 flex-1 rounded-sm'>
                                    <div className='w-[32px] h-[32px]'>
                                    ...
                                    <div>
                                        <p className='text-[15px] text-primary font-bold'>Easy return policy</p>
                                        <p className='text-[12px]'>view policy</p>
                                    </div>
                                </div>
                            </div>
                        </div>
