    ...
    <div className={`bg-white z-50 w-full py-4 shadow-lg ${
      ...
      <div className='w-full hidden lg:block'>
        <div className=' mx-auto max-w-c-1390 flex py-2 w-full justify-between items-center relative lg:px-12 2xl:px-0'>
          <div className='flex items-center gap-10 flex-[.7] relative'>
            <div className='w-32'>
          ...
          <div className='flex gap-4 items-center flex-1'>
            ...
            <button onClick={toggleDrawer} type="button" id="header-bag-icon" className="css-qksfuv">
              <svg 
              width="24px" 
              height="24px" 
              viewBox="0 0 24 24" 
        ...
        <div className='mx-auto max-w-c-1390 relative mt-4 lg:px-12 2xl:px-0 z-0 flex'>
          <NavigationMenu>
            <NavigationMenuList>
